...
def train_model(args, log_file, writer, data_path):
    ...
    for epoch in range(epoch_start_idx, args.num_epochs + 1):
        ...
        for step, batch in enumerate(train_loader):
            ...
            loss, (all_remove_neg_id,all_v_neg_id), pos_sim_expose, pos_sim_click, pos_sim_conv, neg_sim_expose, neg_sim_click, neg_sim_conv = get_loss_streaming(
            ...
            if do_step:
                ...
                output_dict = {
                    ...
                    'sim/pos_sim_expose': pos_sim_expose.item(),
                    'sim/pos_sim_click': pos_sim_click.item(),
                    'sim/pos_sim_conv': pos_sim_conv.item(),
                    'sim/neg_sim_expose': neg_sim_expose.item(), 
                    'sim/neg_sim_conv': neg_sim_conv.item(), 
                    'sim/neg_sim_click': neg_sim_click.item(),
                }
                output_info(global_step=global_step, output_dict=output_dict, writer=writer, is_train=True)
