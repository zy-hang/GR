...
def get_args():
    ...
    parser.add_argument('--neg_cache_steps', type=int, default=3,
...
def get_loss_streaming(args, pos_id, neg_id, pos_logits, neg_bank_tuple,
    ...
    neg_id_vaild = neg_id[mask_all].view(-1)  # [M, num_neg] -> [M * num_neg]
    ...
    return loss, (all_remove_ids_cnt, all_neg_ids_cnt)
