...
class MyDataset(torch.utils.data.Dataset):
    ...
    def _build_buckets(self, expo_counts=None, bucket_weights=None, bank_target=None):
        ...
        if bucket_weights is None:
            w = np.array([0.251, 0.265, 0.274, 0.068, 0.113, 0.029], dtype=np.float64) # 0.251, 0.265, 0.274, 0.068, 0.113, 0.029 # 0.453, 0.196, 0.202, 0.048, 0.082, 0.019   # 0.333, 0.238, 0.246, 0.059, 0.098, 0.026
        else:
